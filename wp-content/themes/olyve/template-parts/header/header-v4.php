<?php
/**
 * Template for displaying header v4
 *
 * @package OlyveTheme
 * @version 1.0.0
 */
...
<?php if ( is_active_sidebar( 'widget-header-one' ) && true == olyve_get_theme_option( 'olyve_header_widget_area_one_enable', false ) || is_active_sidebar( 'widget-header-two' ) && true == olyve_get_theme_option( 'olyve_header_widget_area_two_enable', false ) ) { ?>
<div id="dtr-topbar" class="clearfix">
    <div class="dtr-topbar-content">
        ...
        <div class="dtr-topbar-right dtr-header-widget-two">
